...
class Recorder {
  ...
  constructor(context, params, recorderAppFactor) {
    ...
    this._recorderAppFactory = recorderAppFactor;
  ...
  async install(showRecorder) {
    ...
    await this._context.exposeBinding('__pw_recorderSetSelector', false, async ({
      ...
      await ((_this$_recorderApp3 = this._recorderApp) === null || _this$_recorderApp3 === void 0 ? void 0 : _this$_recorderApp3.setSelector(fullSelector.join(' >> internal:control=enter-frame >> '), true));
    });
