...
class ContextRecorder extends _events.EventEmitter {
  constructor(context, params, delegate) {
    ...
    const collection = new _recorderCollection.RecorderCollection(params.mode === 'recording', params.actionListener);
  ...
  emitSelector(selector) {
    ...
    (_this$_params$actionL = this._params.actionListener) === null || _this$_params$actionL === void 0 || _this$_params$actionL.emit('selector', selector);
  }
  async _onPage(page) {
