...
export class Recorder implements InstrumentationListener {
  ...
  constructor(context: BrowserContext, params: channels.BrowserContextRecorderSupplementEnableParams, recorderAppFactor: (recorder: Recorder) => Promise<IRecorderApp>) {
