...
class PlaywrightDispatcher extends _dispatcher.Dispatcher {
  ...
  async socksConnected(params, metadata) {
  ...
  async socksFailed(params, metadata) {
  ...
  async socksData(params, metadata) {
  ...
  async socksError(params, metadata) {
  ...
  async socksEnd(params, metadata) {
