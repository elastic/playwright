...
class ChannelOwner extends _events.EventEmitter {
  ...
  async _wrapApiCall(func, logger) {
    ...
    try {
      var _this$_csi, _this$_csi2;

      logApiCall(logger, `=> ${apiName} started`);
      (_this$_csi = this._csi) === null || _this$_csi === void 0 ? void 0 : _this$_csi.onApiCall({
        phase: 'begin',
        seq,
        apiName,
      ...
      (_this$_csi2 = this._csi) === null || _this$_csi2 === void 0 ? void 0 : _this$_csi2.onApiCall({
        phase: 'end',
        seq
      });
      ...
      e.stack = e.message + '\n' + frameTexts.join('\n') + innerError;
      (_this$_csi3 = this._csi) === null || _this$_csi3 === void 0 ? void 0 : _this$_csi3.onApiCall({
        phase: 'end',
        seq,
        error: e.stack
      });
