...
class Dispatcher {
  ...
  async _runJob(worker, testGroup) {
    ...
    const onDone = params => {
      ...
      worker.stop();
      const failedTestIds = new Set(); // In case of fatal error, report first remaining test as failing with this error,
      ...
      if (params.fatalError) {
        ...
        for (const test of remaining) {
          ...
          if (test._id !== lastStartedTestId) (_this$_reporter$onTes = (_this$_reporter = this._reporter).onTestBegin) === null || _this$_reporter$onTes === void 0 ? void 0 : _this$_reporter$onTes.call(_this$_reporter, test);
  ...
  _createWorker(testGroup) {
    ...
    worker.on('testBegin', params => {
      ...
      (_this$_reporter$onTes2 = (_this$_reporter2 = this._reporter).onTestBegin) === null || _this$_reporter$onTes2 === void 0 ? void 0 : _this$_reporter$onTes2.call(_this$_reporter2, test);
    });
    ...
    worker.on('progress', params => {
      var _onTestProgress, _ref;

      const {
        test
      } = this._testById.get(params.testId);

      (_onTestProgress = (_ref = this._reporter)._onTestProgress) === null || _onTestProgress === void 0 ? void 0 : _onTestProgress.call(_ref, test, params.name, params.data);
    });
    worker.on('stdOut', params => {
      ...
      (_this$_reporter$onStd = (_this$_reporter3 = this._reporter).onStdOut) === null || _this$_reporter$onStd === void 0 ? void 0 : _this$_reporter$onStd.call(_this$_reporter3, chunk, pair ? pair.test : undefined);
    });
    worker.on('stdErr', params => {
      ...
      (_this$_reporter$onStd2 = (_this$_reporter4 = this._reporter).onStdErr) === null || _this$_reporter$onStd2 === void 0 ? void 0 : _this$_reporter$onStd2.call(_this$_reporter4, chunk, pair ? pair.test : undefined);
    });
    worker.on('teardownError', ({
      error
    }) => {
      var _this$_reporter$onErr, _this$_reporter5;

      this._hasWorkerErrors = true;
      (_this$_reporter$onErr = (_this$_reporter5 = this._reporter).onError) === null || _this$_reporter$onErr === void 0 ? void 0 : _this$_reporter$onErr.call(_this$_reporter5, error);
    });
    worker.on('exit', () => {
  ...
  _reportTestEnd(test, result) {
    ...
    (_this$_reporter$onTes3 = (_this$_reporter6 = this._reporter).onTestEnd) === null || _this$_reporter$onTes3 === void 0 ? void 0 : _this$_reporter$onTes3.call(_this$_reporter6, test, result);
