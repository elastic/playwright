...
function toBeSelected(locator, options) {
  return _toBeTruthy.toBeTruthy.call(this, 'toBeSelected', locator, 'Locator', async timeout => {
    return await locator.evaluate(element => {
...
function toHaveAttr(locator, name, expected, options) {
  return _toMatchText.toMatchText.call(this, 'toHaveAttr', locator, 'Locator', async timeout => {
...
function toHaveData(locator, name, expected, options) {
  return _toMatchText.toMatchText.call(this, 'toHaveData', locator, 'Locator', async timeout => {
    return (await locator.getAttribute('data-' + name, {
      timeout
    })) || '';
  }, expected, options);
}
...
function toHaveProp(locator, name, expected, options) {
  return _toEqual.toEqual.call(this, 'toHaveProp', locator, 'Locator', async timeout => {
