...
class FetchRequest extends _instrumentation.SdkObject {
  ...
  async fetch(params) {
    try {
      ...
      let postData;
      if (['POST', 'PUSH', 'PATCH'].includes(method)) postData = params.formData ? serializeFormData(params.formData, headers) : params.postData;else if (params.postData || params.formData) throw new Error(`Method ${method} does not accept post data`);

      if (postData) {
        var _contentType, _headers$_contentType;

        headers['content-length'] = String(postData.byteLength);
        (_headers$_contentType = headers[_contentType = 'content-type']) !== null && _headers$_contentType !== void 0 ? _headers$_contentType : headers[_contentType] = 'application/octet-stream';
      }
...
function serializeFormData(data, headers) {
  ...
  if (contentType === 'application/json') {
    ...
    (_headers$_contentType2 = headers[_contentType2 = 'content-type']) !== null && _headers$_contentType2 !== void 0 ? _headers$_contentType2 : headers[_contentType2] = contentType;
