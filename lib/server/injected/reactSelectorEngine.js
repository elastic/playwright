...
function findReactRoots() {
  ...
  while (walker.nextNode()) {
    const node = walker.currentNode; // @see https://github.com/baruchvlz/resq/blob/5c15a5e04d3f7174087248f5a158c3d6dcc1ec72/src/utils.js#L329

    if (node.hasOwnProperty('_reactRootContainer')) roots.push(node._reactRootContainer._internalRoot.current);
