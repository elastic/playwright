...
class SnapshotServer {
  ...
  _serveServiceWorker(request, response) {
    ...
    /* ServiceWorkerGlobalScope */
    {
      ...
      async function doFetch(event) {
        ...
        const headers = new Headers(fetchedResponse.headers); // We make a copy of the response, instead of just forwarding,
  ...
  _serveSnapshot(request, response) {
    ...
    const snapshotData = snapshot ? snapshot.render() : {
      html: ''
    };
