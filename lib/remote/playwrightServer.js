...
var _playwright3 = require("../server/playwright");
    ...
    const delegate = {
      ...
      onConnect: async connection => {
        ...
        new _dispatcher.Root(connection, async rootScope => {
          playwright = (0, _playwright3.createPlaywright)();
        ...
        return () => {
          var _playwright, _playwright2;

          cleanup();
          (_playwright = playwright) === null || _playwright === void 0 ? void 0 : _playwright._disablePortForwarding();
          (_playwright2 = playwright) === null || _playwright2 === void 0 ? void 0 : _playwright2.selectors.unregisterAll();
